...
Core/Src/dbg/%.o Core/Src/dbg/%.su Core/Src/dbg/%.cyclo: ../Core/Src/dbg/%.cpp Core/Src/dbg/subdir.mk
...
clean-Core-2f-Src-2f-dbg:
	-$(RM) ./Core/Src/dbg/log.cyclo ./Core/Src/dbg/log.d ./Core/Src/dbg/log.o ./Core/Src/dbg/log.su
