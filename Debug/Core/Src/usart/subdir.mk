...
Core/Src/usart/%.o Core/Src/usart/%.su Core/Src/usart/%.cyclo: ../Core/Src/usart/%.cpp Core/Src/usart/subdir.mk
...
clean-Core-2f-Src-2f-usart:
	-$(RM) ./Core/Src/usart/fsusart.cyclo ./Core/Src/usart/fsusart.d ./Core/Src/usart/fsusart.o ./Core/Src/usart/fsusart.su
