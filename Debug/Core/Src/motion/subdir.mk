...
Core/Src/motion/%.o Core/Src/motion/%.su: ../Core/Src/motion/%.cpp Core/Src/motion/subdir.mk
...
clean-Core-2f-Src-2f-motion:
	-$(RM) ./Core/Src/motion/PIDProfile.d ./Core/Src/motion/PIDProfile.o ./Core/Src/motion/PIDProfile.su ./Core/Src/motion/motor.d ./Core/Src/motion/motor.o ./Core/Src/motion/motor.su ./Core/Src/motion/nmotion.d ./Core/Src/motion/nmotion.o ./Core/Src/motion/nmotion.su ./Core/Src/motion/planner.d ./Core/Src/motion/planner.o ./Core/Src/motion/planner.su ./Core/Src/motion/posprofile.d ./Core/Src/motion/posprofile.o ./Core/Src/motion/posprofile.su ./Core/Src/motion/trajectory.d ./Core/Src/motion/trajectory.o ./Core/Src/motion/trajectory.su
