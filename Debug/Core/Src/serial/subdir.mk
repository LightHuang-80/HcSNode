...
Core/Src/serial/%.o Core/Src/serial/%.su Core/Src/serial/%.cyclo: ../Core/Src/serial/%.cpp Core/Src/serial/subdir.mk
...
clean-Core-2f-Src-2f-serial:
	-$(RM) ./Core/Src/serial/sw_spi.cyclo ./Core/Src/serial/sw_spi.d ./Core/Src/serial/sw_spi.o ./Core/Src/serial/sw_spi.su
