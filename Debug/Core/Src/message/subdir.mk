...
CPP_SRCS += \
../Core/Src/message/message.cpp 

OBJS += \
./Core/Src/message/message.o 

CPP_DEPS += \
./Core/Src/message/message.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/message/%.o Core/Src/message/%.su: ../Core/Src/message/%.cpp Core/Src/message/subdir.mk
...
clean: clean-Core-2f-Src-2f-message

clean-Core-2f-Src-2f-message:
	-$(RM) ./Core/Src/message/message.d ./Core/Src/message/message.o ./Core/Src/message/message.su

.PHONY: clean-Core-2f-Src-2f-message
