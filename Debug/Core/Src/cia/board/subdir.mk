...
Core/Src/cia/board/%.o Core/Src/cia/board/%.su Core/Src/cia/board/%.cyclo: ../Core/Src/cia/board/%.c Core/Src/cia/board/subdir.mk
...
clean-Core-2f-Src-2f-cia-2f-board:
	-$(RM) ./Core/Src/cia/board/CANStm32.cyclo ./Core/Src/cia/board/CANStm32.d ./Core/Src/cia/board/CANStm32.o ./Core/Src/cia/board/CANStm32.su ./Core/Src/cia/board/CO_OD.cyclo ./Core/Src/cia/board/CO_OD.d ./Core/Src/cia/board/CO_OD.o ./Core/Src/cia/board/CO_OD.su
